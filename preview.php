...
<article class="blogs">
    ...
    <div class="index_about">
        <h2 class="c_titile">上传的你的：</h2>
        <h3>
            <strong>信息完善：</strong>
        </h3>
        <div style="text-align:center;">
            <br />
            <form action="tip.php"method="post"enctype="multipart/form-data">
                <input type="hidden" name="concent" value='<?php echo $concent;?>';>
                标题：<input type="input" name="tittle">
                作者：<input type="input" name="author">
        ...
        <h3>
        <p class="box_c"><span class="d_time"></span></p>
        <ul class="infos">
